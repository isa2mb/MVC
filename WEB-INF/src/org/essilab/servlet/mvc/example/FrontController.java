...
import org.essilab.module.index.actions.AfficheIndex;
...
public class FrontController extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		actions.put("index/index", new AfficheIndex());
		//actions.put("annuaire", new AfficheAnnuaire());
		//actions.put("inscription", new UserInsert());
		//actions.put("login", new InsertUser());
		//actions.put("user/inscription_user", new UserInscription());
	}
	@Override
