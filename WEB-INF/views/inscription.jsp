...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <script type="text/javascript" src="res/js/verifierFormulaire.js"></script>
		...
		<div id="maincontainer" class="clearfix">
            ...
            <div id="contentwrapper" style="margin-top:10px;">
                <div class="main_content">
					<div class="row-fluid">
						<div class="span8">
							<center><h3 class="heading">S'inscrire en temps que membre</h3></center>
							<div class="formSep">
								Vous êtes une entreprise? Inscrivez-vous <a href="inscription_entreprise">ici</a>
							</div>
							<form id="form" nom="form" method="post">
								<div class="formSep">
									<label>Nom</label>
									<input type="text" class="span7" id="lastname" name="lastname"/>
								</div>
								<div class="formSep">
									<label>Prenom</label>
									<input type="text" class="span7" id="firstname" name="firstname" />
								</div>
								<div class="formSep">
									<label>E-mail</label>
									<input type="text" class="span7" id="email" name="email" />
								</div>
								<div class="formSep">
									<label>Mot de passe</label>
									<input type="password" class="span7"  id="pwd" name="pwd"/>
									<label>Veuillez retapper votre mot de passe</label>
									<input type="password" class="span7" id="pwd2" name="pwd2"/>
								</div>
								<div class="formSep">
									<input type="checkbox" id="accept" name="accept"/>  J'accepte les termes et conditions d'utilisation
								</div>
								<div class="formSep">
									<input type="button" class="btn btn-success" value="S'inscrire" id="ok" name="ok"  />
								</div>
							</form>
						</div>
                    </div>
