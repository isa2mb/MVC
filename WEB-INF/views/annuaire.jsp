		...
		<div id="maincontainer" class="clearfix">
            ...
            <div id="contentwrapper" style="margin-top:10px;">
                <div class="main_content">
					...
					<div class="row-fluid">
						<div class="span9">
							<center><h3 class="heading">Offres d'emploi <a href="#"><input type="button" class="btn btn-info" value="Ajouter une offre"/></a></h3></center>
								<div class="offre">
									<div>
										<img src="res/styles/default/images/tampon_cdi_mini.png" style="float:left;" />
									</div>
									<div style="float:left; margin-top: -7px; margin-left:5%;">
						...
						<div class="span3">
							<p style="text-align:justify;"><b>Stamp Trooper</b> est devenu le site d'offres d'emploi web et informatique de référence. De nombreuses startups et grandes sociétés du web l'utilisent pour recruter les meilleurs profils spécialisés. </p>
							
							<div style="background-color:#fff8e7; padding-bottom:3px;">
								<div class="offre_spe">
									<center><h3 class="heading">Offres sponsorisées</h3></center>
									<div>
										<center><img src="res/styles/default/images/tampon_cdi_mini.png"/></center>
									</div>
									<div style="margin:10px;">
										<p style="font-size:15px;font-weight:bold;">Chargé de contenu - H/F</p>
										<p style="font-size:12px;font-weight:bold;">Pictograph, <span style="font-size:12px;">Paris (75) </span> - <span>Télétravail</span>	</p>
										<p>Tags : <span class="label label-warning">video</span> <span class="label label-warning">adult</span> <span class="label label-warning">buzz</span></p>
									</div>
								</div>
